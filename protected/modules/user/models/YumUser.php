...
class YumUser extends YumActiveRecord
{
	...
	public function relations()
	{
		...
		if($relations === false) {
			...
			if(Yum::hasModule('forum')){
				Yii::import('application.modules.forum.models.*');
				$relations['forums']=array(self::HAS_MANY,'Forum','user_id');
				$relations['posts']=array(self::HAS_MANY,'Post','user_id');
				$relations['topics']=array(self::HAS_MANY,'Topic','user_id');
				$relations['forumprofile']=array(self::HAS_ONE,'Forumprofile','user_id');
				$relations['subscription']=array(self::HAS_ONE,'Subscription','user_id');
			}
			
			if(Yum::hasModule('pet')){
				Yii::import('application.modules.pet.models.*');
				$relations['pets']=array(self::HAS_MANY,'Pet','user_id');
			}
