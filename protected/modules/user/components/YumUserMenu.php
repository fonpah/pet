...
class YumUserMenu extends CPortlet {
	...
	public function getMenuItems() {
		return array(
				...
				array(
			      	 'label'=>'Pets','items'=>array(
						 	array(
						 			'label'=>'My Pets',
								 	'url'=>array('/pet/pet/index'),
								 	'visible'=>Yum::hasModule('pet')
								 ),
							array(
									'label'=>'Browse Pets',
								 	'url'=>array('/pet/pet/default'),
								 	'visible'=>Yum::hasModule('pet')
							),
							array(
							     'label'=>'Create new Pets',
							 	 'url'=>array('/pet/pet/create'),
							 	 'visible'=>Yum::hasModule('pet')
							)
						)
				),
				array(
			      	 'label'=>'Forum Profile','items'=>array(
						 	array(
						 			'label'=>'My Forum Profile',
								 	'url'=>array('/forum/forumProfile/view'),
								 	'visible'=>Yum::hasModule('forum')
								 ),
							array(
									'label'=>'My Posts',
								 	'url'=>array('/forum/forumProfile/browse'),
								 	'visible'=>Yum::hasModule('forum')
							),
						)
				),
